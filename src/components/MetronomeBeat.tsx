...
export default function MetronomeBeat({
  ...
  return (
    <div
      className={`${active ? "bg-cyan-400" : "bg-transparent"} border ${
        active ? "border-cyan-400" : "border-white-600"
      } rounded py-2 px-1 md:px-2 md:py-3 
